...
if [ -e /usr/bin/yum ] ; then
  ...
  yum -y install git wget make binutils fuse glibc-devel glib2-devel libarchive-static-devel fuse-devel zlib-devel patch openssl-devel vim-common # inotify-tools-devel lz4-devel
