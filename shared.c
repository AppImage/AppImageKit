...
void write_edited_desktop_file(GKeyFile *key_file_structure, char* appimage_path, gchar* desktop_filename, char *md5, gboolean verbose){
    ...
    gchar *icon_with_md5 = g_strdup_printf("appimagekit_%s_%s", md5, g_path_get_basename(g_key_file_get_value(key_file_structure, G_KEY_FILE_DESKTOP_GROUP, G_KEY_FILE_DESKTOP_KEY_ICON, NULL)));
